...
class BlogPostTest < ActiveSupport::TestCase
  test "draft if published_at not set" do
    blog_post = BlogPost.new(title: "title", content: "body")
    assert blog_post.draft?
  end

  test "not draft if published_at set" do
    blog_post = BlogPost.new(title: "title", content: "body", published_at: 3.days.ago)
  ...
  test "not published if published_at set in the future" do
    blog_post = BlogPost.new(title: "title", content: "body", published_at: 3.days.from_now)
